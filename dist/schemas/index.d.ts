 ...
 */
export declare function isEnrichmentNodeConfig(obj: unknown): obj is EnrichmentNodeConfig;
/**
 * Type guard to check if an object is an AnalystConfig
 */
export declare function isAnalystConfig(obj: unknown): obj is AnalystConfig;
/**
 * Type guard to check if an object is a ValidatedAnalystConfig
 */
export declare function isValidatedAnalystConfig(obj: unknown): obj is ValidatedAnalystConfig;
